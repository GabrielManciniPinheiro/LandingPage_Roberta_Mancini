        ...
        >
          ...
          <div style={{ display: "flex", gap: 48 }}>
            ...
            <div>
              ...
              {[
                ...
                <div
                  key={link.id}
                  onClick={() => scrollTo(link.id)} // Adicionada a função de clique
                  style={{
                    fontFamily: "'DM Sans', sans-serif",
                    fontSize: 14,
                    color: "#666",
          ...
          <div style={{ display: "flex", gap: 12 }}>
            {[
              {
                name: "Instagram",
                url: "https://www.instagram.com/roberta_manciniparcerias/", // Coloque o link do insta dela aqui
              ...
              {
                name: "WhatsApp",
                url: "https://wa.me/5511985202715", // Coloque o número dela aqui (com 55 e DDD)
              ...
              <a
                ...
                style={{
                  ...
                  borderRadius: "4px", // Opcional: deixa os cantinhos arredondados
                }}
                onMouseEnter={(e) =>
